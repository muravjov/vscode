...
const defaultLanguages /*: Language[] */ = [
	{ id: 'zh-hant', iso639_3: 'cht' },
	{ id: 'zh-hans', iso639_3: 'chs' },
	{ id: 'ja', iso639_3: 'jpn' },
	{ id: 'ko', iso639_3: 'kor' },
	{ id: 'de', iso639_3: 'deu' },
	{ id: 'fr', iso639_3: 'fra' },
...
const insidersLanguages /*: Language[] */ = [
	{ id: 'pt-br', iso639_3: 'ptb' },
	{ id: 'hu', iso639_3: 'hun' },
	{ id: 'tr', iso639_3: 'trk' }
];
...
if (process.env.VSCODE_QUALITY !== 'stable') {
	languages = languages.concat(insidersLanguages);
}
	...
	return () => {
		...
		const localExtensions = es.merge(...localExtensionDescriptions.map(extension => {
			...
			return ext.fromLocal(extension.path)
				...
				.pipe(nlsFilter)
				.pipe(buffer())
				.pipe(nlsDev.createAdditionalLanguageFiles(languages.map(l => l.iso639_3), path.join(__dirname, '..', 'i18n')))
...
const innoSetupConfig = {
	'zh-hant': { codePage: 'CP936', defaultInfo: { name: 'Simplified Chinese', id: '$0804', } },
	'zh-hans': { codePage: 'CP950', defaultInfo: { name: 'Traditional Chinese', id: '$0404' } },
...
gulp.task('vscode-translations-pull', function () {
	[...defaultLanguages, ...insidersLanguages].forEach(language => {
...
gulp.task('vscode-translations-import', function () {
	[...defaultLanguages, ...insidersLanguages].forEach(language => {
		gulp.src(`../vscode-localization/${language.id}/build/*/*.xlf`)
			...
			.pipe(vfs.dest(`./i18n/${language.iso639_3}`));
